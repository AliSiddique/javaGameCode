...
/** Pick up for balls
 */
public class pickupBall implements CollisionListener {

    private final Zombie zombie;
    public pickupBall(Zombie z){
        this.zombie = z;
    }
    ...
    static {
        try {
            ballSound = new SoundClip("data/balls.wav");
     ...
     */    public void collide(CollisionEvent e) {
        if (e.getOtherBody() instanceof Balls) {
